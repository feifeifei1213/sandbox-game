...
type ReportComputedPayload struct {
	...
	ReportBestMarketDirectorBaseScore float64 `json:"reportBestMarketDirectorBaseScore"`
	ReportBestMarketDirectorScore     float64 `json:"reportBestMarketDirectorScore"`
	ReportBestTechnologyDirectorScore float64 `json:"reportBestTechnologyDirectorScore"`
	ReportBestSalesDirectorScore      float64 `json:"reportBestSalesDirectorScore"`
	ReportBestCfoBaseScore            float64 `json:"reportBestCfoBaseScore"`
	ReportBestCfoScore                float64 `json:"reportBestCfoScore"`
	ReportBestCeoScore                float64 `json:"reportBestCeoScore"`
}
