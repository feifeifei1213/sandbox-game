...
set "BACKUP_ROOT=D:\deploy\_backup\guibing"
set "APP_PORT=28080"
set "LAUNCHER_ROOT=D:\deploy\launcher"
set "RESTART_SCRIPT=%LAUNCHER_ROOT%\重启服务版服务.bat"
...
echo 不要把更新包直接解压到 D:\deploy\sandbox-game-guibing。
echo.
...
echo 请手工双击 D:\deploy\launcher\重启服务版服务.bat
