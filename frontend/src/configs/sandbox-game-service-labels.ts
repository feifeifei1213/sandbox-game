export const serviceOperatingLabels = {
  ...
  marketProductFields: [
    { key: 'basicProductTotal', label: '代办过检服务总价' },
    { key: 'standardProductTotal', label: '两舱贵宾服务总价' },
    { key: 'precisionProductTotal', label: '商务贵宾服务总价' },
    { key: 'intelligentProductTotal', label: '会员定制服务总价' },
  ],
  materialFields: [
